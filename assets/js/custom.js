...
======================================*/
	...
	// 4. View More/Less Screenshots Toggle
	function toggleButtonText(button) {
		var viewMoreText = button.querySelector('.view-more-text');
		var viewLessText = button.querySelector('.view-less-text');
		
		if (viewMoreText.style.display !== 'none') {
			// Currently showing "View More", change to "View Less"
			viewMoreText.style.display = 'none';
			viewLessText.style.display = 'inline';
		} else {
			// Currently showing "View Less", change to "View More"
